***PROGRAMA DE MANTENIMIENTO APROBADO (AMP)***

***Aeronaves Ligeras \- Parte-ML (No Comerciales)***

***(Aplicable a aeronaves que No realicen Transporte Aéreo Comercial y que No sean consideradas Aeronaves grandes)***
...
El presente Programa de Mantenimiento (AMP) define las tareas necesarias para asegurar la aeronavegabilidad continuada de la aeronave indicada, conforme al Reglamento (UE) 1321/2014, Anexo Vb (Parte-ML), aplicable a aeronaves distintas de las complejas, operadas en categoría no comercial.
...
| Anexo 1 | Report de revisiones (Inspecction Chart) |  | 1.0 |
...
Este Programa de mantenimiento se actualizará con la última edición / revisión de los manuales y documentación técnica detallada. Cuando una nueva edición / revisión de la documentación suponga una modificación de este programa se procederá a enmendar el mismo y se presentará para su aprobación en la OSV correspondiente. El responsable de la revisión y enmienda de este programa será el Responsable de Aeronavegabilidad de la organización CAMO contratada (CAMO, MG-ES-XXXX)  
...
## **8.1 Intervalos de Inspección**

En este apartado se indica la relación de las inspecciones del programa base de mantenimiento, así como sus intervalos y posibles ampliaciones. Estos intervalos están establecidos de acuerdo a una utilización de la aeronave prevista en el apartado 6\.
...
En esta sección se enumeran las recomendaciones especiales de mantenimiento publicadas por el Estado de matrícula/Estado del operador (AOC). Esta sección debe proporcionar acciones de mantenimiento relacionadas con los siguientes requisitos operativos especiales aplicables a la flota (lista no completa):

* Operaciones en todo clima (AWOPS – CAT II/CAT III).  
* Separación vertical mínima reducida (RVSM).  
* Procedimientos de mantenimiento de Especificaciones mínimas de rendimiento de navegación (MNPS).  
* Vigilancia dependiente automática – Transmisión (ADS-B).  
* Estándares de rendimiento de operaciones con dos motores de alcance extendido (ETOPS).

En esta sección también se deben enumerar los requisitos extraídos de las disposiciones aplicables del Anexo I (Parte 26\) del Reglamento (UE) 2015/640 y del Anexo IV (Parte CAT) del Reglamento (UE) 965/2012.

| Requisito | Material Guía o Referencia | Descripción | Intervalo | Referencia |
| ----- | ----- | ----- | ----- | ----- |
| CAT.GEN.MPA.195 | AMC1 CAT.GEN.MPA.195 (b) GM1 CAT.GEN.MPA.195 (b) | CVR/FDR Tests Inspections of the CVR and FDR recording **(Cajas Negras)** |  |  |
| CAT.POL.MAB.100 |  | **Weighing (Peso y centrado)** | **4 años** |  |
| CAT.IDE.A.220 225 | AMC2 CAT.IDE.A.220 | First-aid kit Inspection |  |  |
| CAT.IDE.A.280 | AMC1 CAT.IDE.A.280  | **Emergency Locator Transmitters and Personal Locator Beacon \- Annual Testing** | **12 meses** | EASA SIB [2019-09R1](https://ad.easa.europa.eu/ad/2019-09R1) |
| Part-26 \- 26.370(a)(iii)	 | CS 26.370 | **Transponder systems Test** | **24 meses** | EASA [SIB 2011-15](https://ad.easa.europa.eu/ad/2011-15R2)R2 |
| Part-26 \- 26.201 | CS 26.201 | Tyre inflation pressure check |  |  |
| Part-26 \- 26.370(a)(i) | **CS 26.370** | Approved damage-tolerance-based inspection programme |  |  |
| Part-26 \- 26.370(a)(iii) | CS 26.370 | LOV \- or more restrictive applicable limitation |  |  |
|  |  |  |  |  |

## **8.2.- 	Períodos limpieza, engrase, lubricación y relleno de fluidos**
...
**Nota 1\.** Las ampliaciones de los intervalos recomendados por **EASA** como máximos, **cuando no exista indicaciones del Titular del Certificado de tipo**, son los siguientes:

**Nota 2\.** Como regla general, las variaciones permitidas no se aplican a **ninguna tarea obligatoria**, como por ejemplo (lista no exhaustiva): ADs, ALIs, LLI, CMR, FAL,  Engine ALS, Aircraft Weighing.

# **10 REQUISITOS DE MANTENIMIENTO ADICIONAL**

Additional maintenance requirements

## **10.1 Mantenimiento debido a componentes con vida límite (life-limited components, OH/TBO)**

En este punto se deberán indicar aquellos componentes que tengan una vida limitada (por horas voladas, ciclos o fecha). Que bien estén sujetos a **overhaul** o a **sustitución** por **nuevo**, su intervalo especificado por el propietario del Certificado de Tipo o fabricante del componente, o la Autoridad nacional de aviación y la documentación de referencia que lo soporta.

Nota: **No se permite ninguna variación ni extensión** en los componentes para los cuales se haya prescrito una vida útil final (descarte) o un límite de revisión general (Overhaul).
...
En este punto se deberán indicar aquellas **Limitaciones Estructurales y de Aeronavegabilidad** de elementos estructurales con vida en servicio o componentes estructurales y de motor también con vida a servicio límite, con una limitación operativa por horas voladas, ciclos o calendario, que normalmente estarán sujetos a **sustitución** por **nuevo**, su intervalo especificado por el propietario del Certificado de Tipo o fabricante del componente, o la Autoridad nacional de aviación y la documentación de referencia que lo soporta.
...
Basado en la Guía EASA UG.CAMO.00010-001 (2023) y la Guía AESA AC-PMNA-P01-DT01 Ed.01【7†AC-PMNA-P01-DT01】【8†ug.camo\_.00010-001】.
