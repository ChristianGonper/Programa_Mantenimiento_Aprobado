...
| Inspecciones o revisiones normales de mantenimiento programado | Contenido | Intervalo | Ampliación | Referencia |
| :---: | :---: | :---: | :---: | :---: |
...
| Inspecciones especiales fuera de las revisiones estándar | Contenido | Intervalo | Ampliación | Referencia |
| :---: | :---: | :---: | :---: | :---: |
...
## **8.3 Requisitos operacionales y pruebas periódicas**

En esta sección se registran las tareas operacionales que se controlan de forma independiente en el Excel `Tasks`, sin mezclarlas con inspecciones especiales ni con componentes de vida límite.

| Requisito / tarea | Descripción | Intervalo | Referencia |
| ----- | ----- | ----- | ----- |
...
## **8.4 Períodos limpieza, engrase, lubricación y relleno de fluidos**
...
Basado en la Guía EASA UG.CAMO.00010-001 (2023), la Guía AESA AC-PMNA-P01-DT01 Ed.01 y la documentación técnica trazada en `trazabilidad/`.
