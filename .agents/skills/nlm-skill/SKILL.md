---
name: nlm-skill
description: "Expert guide for the NotebookLM CLI (`nlm`) and MCP server - interfaces for Google NotebookLM. Use this skill when users want to interact with NotebookLM programmatically"
version: "0.6.6"
---
...
1. **Use CLI tools**: Use `nlm` CLI commands via Bash
...
### Pattern 1: Quick Content Ingestion
...
### Pattern 2: Study Materials Generation
...
### Pattern 3: Drive Document Workflow
...
### Pattern 4: Batch & Cross-Notebook Workflow
